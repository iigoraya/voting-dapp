...
let candidates = {"Mohammad": "candidate-1", "Ibrahim": "candidate-2", "Ismail": "candidate-3"}
...
const App = {
  ...
  loadCandidatesAndVotes: async function() {
    ...
    for (let i = 0; i < candidateNames.length; i++) {
      ...
      let count = await totalVotesFor(this.web3.utils.asciiToHex(name)).call();
  ...
  voteForCandidate: async function() {
    ...
    let count = await totalVotesFor(this.web3.utils.asciiToHex(candidateName)).call();
    $("#" + div_id).html(count);
    $("#msg").html("");
  }
